...
ncr_data %>%
  ...
  filter(date_created > 2017,
         date_created < 2023,
         district %in% c("Glasgow City", "Dumfries and Galloway", 
                         "South Lanarkshire", "Fife", "City of Edinburgh", 
                         "East Lothian")) %>% 
  ...
  labs(
    x = "\n Year",
    y = "New Devices Added \n",
    title = "New Devices Added To NCR: The Last 5 Years In Scotland",
    subtitle = "Where Total Devices Is Greater Than 50",
